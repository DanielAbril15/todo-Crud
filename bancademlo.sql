...
accounts.account_no,
accounts.balance 
from clients left join accounts 
...
accounts.client_id,
account_types.name 
from accounts right join account_types 
...
from transactions left join transactions_types 
...
transactions.amount,
transactions_types.name
from transactions right join transactions_types 
on transactions.transaction_type  = transactions_types.id;
